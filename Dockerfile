...
FROM --platform=linux/arm64 ghcr.io/kong/kong-openssl:1.5.0-aarch64-linux-musl as aarch64-linux-musl
FROM --platform=linux/arm64 ghcr.io/kong/kong-openssl:1.5.0-aarch64-linux-gnu as aarch64-linux-gnu
